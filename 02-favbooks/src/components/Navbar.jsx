const Navbar = () => {
  return (
    <>
      <div className="bg-[#606c38] py-4 px-20   flex items-center justify-between text-[#fefae0]">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="font-mono text-4xl">Your Library</h1>
        </div>
        <div>
          <a
            href="https://github.com/GayathriHG/firebase-tasks/tree/main/02-favbooks"
            target="blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="38"
              height="38"
              className="hover:text-[#283618] cursor-pointer "
              viewBox="0 0 256 256"
            >
              <path
                fill="currentColor"
